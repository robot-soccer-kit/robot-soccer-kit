...
// In chassis frame, the front axis is the x axis running through the kicker of
// the robot Those are orientation of the driving direction of the wheels,
// assuming they rotate in the direction that makes the robot rotate p=ositively
#ifdef BOARD_REV2
...
// Below this voltage, the robot won't start moving, between USB voltage (see
// below) and this voltage, the robot will enter alarm mode
